...
from seckill.utils import get_useragent_data


seckill_time = "2018-11-11 00:00:00"
seckill_time_obj = datetime.strptime(seckill_time, '%Y-%m-%d %H:%M:%S')
